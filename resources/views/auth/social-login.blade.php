    ...
    <div class="col-md-6">
      <div class="card-body">
        <login inline-template> 
          <form action="{{ route('postLogin') }}" method="POST" class="bg-white p-4 col-md-offset-4">
           ...
           <button href="{{ route('facebookLoginForm') }}" type="submit" class="btn btn-lg btn-block text-2xl btn-primary">{{ trans('auth.social.facebook') }}
           </button>
         </form>
       </login>
     </div>
